...
export default function EditarContato() {
        ...
        Alert.alert(
            ...
            [
                ...
                },
                {
                    ...
                    style: "destructive",
                    onPress: async () => {
                        await excluirContato(contato.id); // Função que exclui o contato
    ...
    useFocusEffect(
        ...
        }, [contato.id]) // Esse código será executado sempre que a tela entrar em foco
    );
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <TextInput
                        style={styles.input}
                        placeholder="Celular"
                        value={formatarTelefone(celular)} // Exibe o telefone formatado
                        onChangeText={handleCelularChange} // Atualiza o número sem formatação
